...
// Tetris pieces - Deep Ocean Theme (Cyan, Blue, Teal)
const TETRIS_PIECES = [
    // I-piece (Cyan)
    { shape: [[1, 1, 1, 1]], color: 'bg-cyan-400 shadow-[0_0_10px_rgba(34,211,238,0.5)]' },
    // O-piece (Blue)
    { shape: [[1, 1], [1, 1]], color: 'bg-blue-500 shadow-[0_0_10px_rgba(59,130,246,0.5)]' },
    // T-piece (Teal)
    { shape: [[0, 1, 0], [1, 1, 1]], color: 'bg-teal-400 shadow-[0_0_10px_rgba(45,212,191,0.5)]' },
    // L-piece (Sky)
    { shape: [[1, 0], [1, 0], [1, 1]], color: 'bg-sky-500 shadow-[0_0_10px_rgba(14,165,233,0.5)]' },
    // S-piece (Indigo)
    { shape: [[0, 1, 1], [1, 1, 0]], color: 'bg-indigo-400 shadow-[0_0_10px_rgba(129,140,248,0.5)]' },
    // Z-piece (Cyan-600)
    { shape: [[1, 1, 0], [0, 1, 1]], color: 'bg-cyan-600 shadow-[0_0_10px_rgba(8,145,178,0.5)]' },
    // J-piece (Blue-600)
    { shape: [[0, 1], [0, 1], [1, 1]], color: 'bg-blue-600 shadow-[0_0_10px_rgba(37,99,235,0.5)]' },
]
    ...
    return (
        <div>
            <div className="mb-6 flex justify-center">
                <div className={`border-2 border-cyan-500/30 bg-black/40 ${config.padding} transition-colors backdrop-blur-sm shadow-[0_0_20px_rgba(6,182,212,0.1)] rounded-lg`}>
                    {renderGrid()}
                </div>
            </div>
            ...
            {showLoadingText && (
                <div className="text-center">
                    <p className="text-cyan-400 font-display uppercase tracking-widest text-sm animate-pulse">{loadingText}</p>
                </div>
            )}
        </div>
    )
